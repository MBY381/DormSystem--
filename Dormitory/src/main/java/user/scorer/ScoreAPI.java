...
public class ScoreAPI {
    ...
    public
    Result getScoreList( ScoreRecord dto){
    ...
    public
    Result setTempWeekno( @RequestBody ScoreRecord dto){
    ...
    public
    Result getDraftList( ScoreRecord dto){
    ...
    public
    Result setScore( @RequestBody List<ScoreRecordDto> list){
    ...
    public
    Result setScoreRecord( @RequestBody ScoreRecordDto dto, @RequestHeader("Token") String Token) {
    ...
    public
    Result setMultipleRecord( @RequestBody List<ScoreRecordDto> list){
    ...
    public
    Result deleteRecord( @RequestBody ScoreRecordDto dto){
    ...
    public
    Result updaterecord( @RequestBody ScoreRecordDto dto, @RequestHeader("Token") String Token){
    ...
    public
    Result scoreList( @RequestHeader("Token") String token){
