...
public class GeneralAPI {
    ...
    @DeleteMapping("/exit")
    public
    Result exit( @RequestHeader("Token") String token){
        //在服务端清除缓存的token
    ...
    @PostMapping("/avatar")
    public
    Result uploadAvatar( MultipartFile avatar, @RequestHeader("Token") String token) throws IOException {
    ...
    public
    Result getCurr_User( @RequestHeader("Token") String Token){
    ...
    public
    Result changePwd( @RequestBody CommonDto dto, @RequestHeader("Token") String Token){
