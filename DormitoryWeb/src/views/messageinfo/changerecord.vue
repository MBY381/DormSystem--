    ...
    <a-layout>
      ...
      <a-layout style="padding: 0 24px 24px">
        <a-breadcrumb style="margin: 16px 0">
          ...
          <a-breadcrumb-item>换宿记录</a-breadcrumb-item>
            </a-breadcrumb>
...
const columns = [
  ...
  {
    dataIndex: "newdorm_id", //服务端数据
    title: "申请寝室号", //表头项名称
   
  },
  {
    dataIndex: "change_status", //服务端数据
    title: "申请状态", //表头项名称
    slots:{
      customRender:"change_status"
    },
  },
];
...
const getPage = (pageNum = 1) => {
  ...
  get("/messageinfo/changerecord", query).then((res) => {
