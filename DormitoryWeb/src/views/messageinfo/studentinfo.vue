    ...
    <a-layout>
      ...
      <a-layout style="padding: 0 24px 24px">
        <a-breadcrumb style="margin: 16px 0">
          ...
          <a-breadcrumb-item>寝室得分</a-breadcrumb-item>
            </a-breadcrumb>
...
const columns = [
  ...
  {
    dataIndex: "dorm_score", //服务端数据
    title: "寝室得分", //表头项名称
  },
  
  {
    dataIndex: "student_num", //服务端数据
    title: "寝室人数", //表头项名称
  },
  {
    dataIndex: "dorm_sex", //服务端数据
    title: "性别", //表头项名称
    slots:{
      customRender:"dorm_sex"
    },
  },
];
...
const getPage = (pageNum = 1) => {
  ...
  get("/messageinfo/studentinfo", query).then((res) => {
